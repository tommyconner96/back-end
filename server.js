...
server.use((req, res, next) => {
    res.header("Access-Control-Allow-Origin", 'https://front-end-git-axiosadd.buildweek-water-my-plants-3.vercel.app')
...
server.use(cors({
    credentials: true,
    origin: 'https://front-end-git-axiosadd.buildweek-water-my-plants-3.vercel.app',
}))
